$(function () {
    ...
    function renderPage(total) {
        ...
        laypage.render({
            ...
            // 触发 jump 回调的方式有两种：
            // 1.点击页码的时候，会触发 jump 回调 （first 为 fault）
            // 2.只要调用了 laypage.render() 方法，就会触发 jump 回调 （first 为 true）
            jump: function(obj, first) {
                ...
                q.pagenum = obj.curr
                // 把最新条目数，赋值到 q 这个查询参数对象的 pagesize 属性中
